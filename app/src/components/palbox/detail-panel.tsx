// The selected-pal detail panel, extracted from SaveInspector so the Palbox
// grid, the party/base/dimensional surfaces, and the list table all open the
// same panel (contract: the roster detail is reused, never forked). Sits beside
// the surface at wide widths and overlays below `xl` so nothing gets crushed.

import { useState } from "react";
import type { OwnedPal, PlayerRef } from "../../lib/types";
import { containerLabel, genderView, ivBand, QUALITY_FILL, QUALITY_TEXT } from "../../lib/ui";
import { PalIcon, PassiveChip, Tag } from "../primitives";
import { hexGuid } from "./selectors";

/** A labelled IV bar: label above, numeral, wide bar. */
...
export function PalDetail({
  ...
  return (
    <aside className="absolute right-0 top-0 z-20 flex h-full w-[380px] max-w-[85vw] flex-col border-l border-line bg-panel xl:static xl:z-auto">
